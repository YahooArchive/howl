...
import org.apache.howl.rcfile.RCFileInputDriver;
import org.apache.howl.rcfile.RCFileOutputDriver;
...
//  }
  ...
  public void testPartColsInData() throws IOException{
    ...
    String createTable = "create table junit_unparted(a int) partitioned by (b string) stored as RCFILE " +
        "tblproperties('howl.isd'='org.apache.howl.rcfile.RCFileInputDriver'," +
    ...
    server.registerQuery("store A into 'default.junit_unparted' using org.apache.howl.pig.HowlStorer('b=1');");
