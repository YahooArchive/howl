 ...
 */
public class HowlException extends IOException {
   ...
   */
  public HowlException(ErrorType errorType, Throwable cause) {
   ...
   * @param cause the cause
   */
  public HowlException(ErrorType errorType, String extraMessage, Throwable cause) {
   ...
   * @param cause the cause
   */
  public HowlException(String message, Throwable cause) {
  ...
  public static String buildErrorMessage(ErrorType type, String extraMessage, Throwable cause) {
    ...
    StringBuffer message = new StringBuffer(HowlException.class.getName());
