...
@Deprecated
public class DeprecatedHowlFieldSchema extends FieldSchema {
    /**
     *
     */
     ...
     * @param other
     */
    public DeprecatedHowlFieldSchema(FieldSchema other) {
        super(other);
     ...
     */
    public DeprecatedHowlFieldSchema(String name, String type, String comment) {
